...
| `agents-skills/` | Community suite under `~/.agents/skills/`: 24 validated skills with Karpathy-guided assumptions, surgical changes, and goal checks (security assessment, academic, AI/RAG/MCP, application security, TDD, evidence-first execution, provenance hygiene, caveman, ponytail, agent-browser, etc.) |
